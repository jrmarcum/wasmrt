...
| **8** | 🔒 **`1.0.0` release prep is ON HOLD until wazmrt's copy of the contract SETTLES** (owner, 2026-09-19). Then, in order: mirror their numbering, re-measure the corpus, re-take the size/speed numbers, and run `releasing.md`. | T13's exit. ⚠️ Releasing mid-coordination would publish a contract state that changes days later — and §1d already says to reconcile against code that has stopped moving. |
...
##### 🚨 OPEN LOOP (2026-09-19) — wazmrt folded in the PRE-NARROWING §2.4a as v11
