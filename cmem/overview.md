...
- **T9 (0.10.0, IN PROGRESS)** — first pass landed **2026-08-07**, unreleased. Six correctness defects
  ...
  first time in the project's life**. Suite **61,778 / 496 / 2,466 — 99.2%** (2026-08-08, after T9a#4's memory half, link-time import type checking, and the decoder-strictness pass), no file lost a pass.
...
See the task list in [roadmap.md](roadmap.md). **404 workspace tests** green; clippy clean; native +
