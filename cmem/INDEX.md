...
## ◐ T9 IN PROGRESS (2026-08-08) — two passes landed today, unreleased

Working tree is **ahead of the published v0.9.0**. Suite **61,691 / 599 / 2,469 — 99.0%** of 62,290
adjudicated — **the first time over 99%**; **386 tests** (was 363); clippy, all four surfaces, the C-ABI
gate (74/74 + `c_smoke`) and Miri (26/26) green. **No file lost a single pass** in either pass — the check
that matters whenever skips convert into verdicts.
