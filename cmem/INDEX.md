...
## ◐ T9 IN PROGRESS (2026-08-07) — first pass landed, unreleased

Working tree is **ahead of the published v0.9.0**. Suite **98.8% → 98.9%** (61,247 / 655 / 2,932);
**363 tests** (was 351); clippy, all four surfaces, the C-ABI gate and Miri green; **no file regressed**.
...
**Still open in T9:** T9a #4 (gated), #5, #6, #7, #8, #9, #11, #12 · **T9e `pin`** (still a stub — a
build performs **no** authenticity check) · **T9f tail calls** (1.0 cannot be claimed without them).
