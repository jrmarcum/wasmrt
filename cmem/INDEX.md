...
order: ~~track A~~ ✅ **done 2026-09-19 as the custom-annotations feature** (`custom/` 20/0/0; see `roadmap.md`, DAY 4 part 2) → **the import type-use check** → **track P** →
**track D** (now 98% of what remains, and unblocked — `Op` has 0xEB free tags).

Working tree is **ahead of the published v0.9.0**. Suite **64,087 / 65 / 530 — 99.9% of 64,152** over
**288** files (day 4, 2026-09-19); **514 workspace tests**; clippy ⚠️ **NOT clean — 3 pre-existing warnings** (`opcode.rs` dead `ImmKind` variants, two `thread_local` const initializers; none added by day 4); C-ABI gate PASSED (74 symbols); `.wat` corpus
