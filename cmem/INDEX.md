...
- `scripts/c-gate.ts` — the C-ABI gate (link-completeness 74/74 + `c_smoke` compiled against the shipped
  header). `scripts/miri-gate.ts` — `wasmrt-capi` under Miri (28/28), incl. a lifecycle fuzz.
