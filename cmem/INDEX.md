...
## ◐ T9 IN PROGRESS (2026-08-08) — three passes landed today, unreleased

Working tree is **ahead of the published v0.9.0**. Suite **61,691 / 599 / 2,469 — 99.0%** of 62,290
adjudicated — **the first time over 99%**; **389 tests** (363 core + 26 capi); clippy, all four surfaces,
...
and that asymmetry *was* the bug. Mutation-verified; conformance **unchanged** (61,691/599/2,469), because
