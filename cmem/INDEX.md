...
Working tree is **ahead of the published v0.9.0**. Suite **64,067 / 65 / 550 — 99.9% of 64,132** over
**288** files (day 4, 2026-09-19); **506 workspace tests**; clippy ⚠️ **NOT clean — 3 pre-existing warnings** (`opcode.rs` dead `ImmKind` variants, two `thread_local` const initializers; none added by day 4); C-ABI gate PASSED (74 symbols); `.wat` corpus
