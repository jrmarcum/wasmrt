...
## ◐ T9 IN PROGRESS (2026-08-08) — six passes landed today, unreleased

Working tree is **ahead of the published v0.9.0**. Suite **61,738 / 536 / 2,466 — 99.1%** of 62,274
adjudicated — **the first time over 99%**; **401 tests** (375 core + 26 capi); clippy, all four surfaces,
the C-ABI gate (74/74 + `c_smoke`) and Miri (26/26) green. **No file lost a single pass** in any of the
six passes — the check that matters whenever skips convert into verdicts.
