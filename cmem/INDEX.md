...
**Progress (2026-08-03): T0–T3 + T4-core + T5 slices 1–9 DONE, released v0.1.0 → v0.6.8 (published through
v0.6.7; v0.6.8 prepped, awaiting owner publish).** `wasmrt-core` has `types` + `reader` + `opcode` (shared IR +
