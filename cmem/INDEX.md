...
**Next: T9 — now scoped from a measured audit (`roadmap.md`), not from old notes.** Its top item is a
**one-match-arm** assembler fix (`ref.null $ConcreteType`) worth **161 skipped assertions in
