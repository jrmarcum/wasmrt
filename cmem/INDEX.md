...
## ◐ T9 IN PROGRESS (2026-08-08) — eleven passes landed today, unreleased

Working tree is **ahead of the published v0.9.0**. Suite **61,987 / 441 / 2,247 — 99.3%** of 62,428
adjudicated; **426 tests** (398 core + 28 capi); clippy, all four surfaces, the C-ABI gate
(74/74 + `c_smoke`, now asserting real trap frames) and Miri (28/28) green. **No file lost a single
pass** in any of the eleven passes — the check that matters whenever skips convert into verdicts.
...
**Still open in T9:** T9a **#8**, **#9**, and #12's **text-parser** remainder (`func.wast` 8, in
`wat.rs` not `module.rs`) · **T9e `pin`** (still a stub — a build performs **no** authenticity check) ·
