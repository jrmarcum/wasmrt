...
| [overview.md](overview.md) | What wasmrt is, the oracle, repo/crate layout, mental model, and the **stage-by-stage status through T9's eleven passes** — 99.3%, 426 tests, and the **eight defects no list had**, not one of which was found by reading the punch-list |
