...
## ◐ T9 IN PROGRESS (2026-08-08) — twelve passes landed today, unreleased

Working tree is **ahead of the published v0.9.0**. Suite **62,037 / 393 / 2,245 — 99.4%** of 62,430
adjudicated; **435 tests** (407 core + 28 capi); clippy, all four surfaces, the C-ABI gate
(74/74 + `c_smoke`, now asserting real trap frames) and Miri (28/28) green. **No file lost a single
pass** in any of the twelve passes — the check that matters whenever skips convert into verdicts.
